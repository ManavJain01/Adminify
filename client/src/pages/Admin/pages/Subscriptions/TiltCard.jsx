  ...
  return (
    ...
    >
      ...
      >
        ...
        <section
          style={{ transform: "translateZ(50px)" }}
          className="font-semibold text-xl w-full flex flex-col gap-3 items-center"
        >
        ...
        <button
          style={{ transform: "translateZ(50px)" }}
          className="text-white bg-blue-700 group-hover:text-blue-900 group-hover:bg-white w-full mt-auto px-5 py-2 rounded-lg group-hover:shadow-xl"
        >
          {data.more}
        </button>
      </div>
